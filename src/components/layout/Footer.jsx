    ...
    <footer className="w-full bg-[#050505] text-zinc-400 pt-36 pb-30 md:pb-60 px-6 md:px-10  font-outfit">
        ...
        <div className="lg:col-span-2 space-y-2">
          ...
          <div className="space-y-4">
            <p className="text-[15px] font-medium leading-tight max-w-[350px]">
              CSSFrames | The open-source universe of high-performance CSS
              animations.
            </p>
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-1 text-white font-bold  relative right-1.5">
                ...
                <span className=" font-heading text-[16px] tracking-wide">
                  MIT License
                </span>
              </div>
              <p className="text-[16px] leading-tight max-w-[400px] text-zinc-400">
                All elements on this site are open-source and published under
                the
                <a
                  href="#"
            ...
            <ul className="space-y-3">
              {links.map((link) => (
                <li key={link}>
                  <a
                    href="#"
                    className="text-[15px] font-medium hover:text-white transition-all  inline-block"
                  >
                    {link}
                  </a>
                </li>
      ...
      <div className="max-w-full mx-auto mt-10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="flex items-center gap-1 text-[11px] md:text-[16px] font-nomral tracking-wide text-zinc-500">
          ...
          <span>All rights reserved - CSSFrames</span>
        </div>
      </div>
    </footer>
  );
