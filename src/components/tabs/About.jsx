...
import {  Code2, Sparkles, Zap, Layout , User } from 'lucide-react';

export default function About() {
  return (
    <>
      {/* Header  */}
      <div className="flex flex-col gap-5 items-start border-b border-zinc-900 px-8 py-6 pb-4 mb-8 ">
        <div className="flex items-center gap-1 text-white ">
          <User size={18} /> <span>About</span>
        </div>
      </div>
      <div className="px-6 bg-black py-20 font-outfit overflow-y-auto h-full max-w-[100%] mx-auto scroll">
        {/* hero section */}
        <header className="mb-24 text-center">
          ...
          <p className="max-w-2xl mx-auto text-lg text-zinc-400 leading-relaxed">
            Cssframes is an open-source library built for designers and developers who believe that
            animations shouldn't just be an afterthought—they should be an experience.
          </p>
        </header>
          ...
          <div className="relative bg-[#090909] border border-zinc-800 rounded-[3rem] p-12 flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-zinc-500 mb-8 leading-relaxed">
                ...
                animations. We wanted a central hub for high-quality, "Apple-style" motion that
                works anywhere. Built by developers, for developers.
              </p>
